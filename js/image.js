...
class ImageInstance {
    ...
    static newCardImage() {
        ...
        let ret = templateCardImg.cloneNode(true);
        ret.classList.remove("template");
        ret.removeAttribute("id");
        return ret;
    }
    CreateImageNode(indexOfStorage) {
    ...
    GetCardNode() {
        return this.imageNode.parentNode.parentNode.parentNode.parentNode;
    }
    GetImageHTMLNode() {
